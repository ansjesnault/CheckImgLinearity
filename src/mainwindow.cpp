...
void MainWindow::keyPressEvent(QKeyEvent * event)
{
	if( ! QApplication::keyboardModifiers().testFlag(Qt::ControlModifier) )
	{
		switch (event->key())
		{
		case Qt::Key::Key_0 : setupDemo(0); break;
		case Qt::Key::Key_1 : setupDemo(1); break;
		case Qt::Key::Key_2 : setupDemo(2); break;
		case Qt::Key::Key_3 : setupDemo(3); break;
		case Qt::Key::Key_4 : setupDemo(4); break;
		case Qt::Key::Key_5 : setupDemo(5); break;
		case Qt::Key::Key_6 : setupDemo(6); break;
		case Qt::Key::Key_7 : setupDemo(7); break;
		case Qt::Key::Key_8 : setupDemo(8); break;
		case Qt::Key::Key_9 : setupDemo(9); break;
		default:
			break;
		}
	}
	else
	{
		switch (event->key())
		{
		case Qt::Key::Key_0 : setupDemo(10);
		case Qt::Key::Key_1 : setupDemo(11); break;
		case Qt::Key::Key_2 : setupDemo(12); break;
		case Qt::Key::Key_3 : setupDemo(13); break;
		case Qt::Key::Key_4 : setupDemo(14); break;
		case Qt::Key::Key_5 : setupDemo(15); break;
		case Qt::Key::Key_6 : setupDemo(16); break;
		case Qt::Key::Key_7 : setupDemo(17); break;
		case Qt::Key::Key_8 : setupDemo(18); break;
		case Qt::Key::Key_9 : setupDemo(19); break;
		default:
			break;
		}
	}
